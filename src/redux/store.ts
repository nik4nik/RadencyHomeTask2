...
const reducer = createReducer(initialState, (builder) =>
  builder
    .addCase(actions.removeNote, (state, action) => ({
      ...state,
    ...
    .addCase(actions.openEdt, (state, action) => {
      const newModal = {
    ...
    .addCase(actions.openAdd, (state, action) => {
      const newModal = {
        name: "",
        text: "",
        category: "",
    ...
    .addCase(actions.edit, (state, action) => ({
      ...state,
    ...
    .addCase(actions.archive, (state, action) => {
    ...
    .addCase(actions.unarchive, (state, action) => {
      const newNotes = state.notes.map((note) => {
        if (note.id === action.payload) {
    ...
    .addCase(actions.changeTableData, (state, action) => {
      return {
        ...state,
